...
class Gerador {
	...
	public function getCopyright() {
		$txt  = "Desenvolvido por Diego Gomes Araujo<br>";
		$txt .= "Email: diegogomesaraujo@hotmail.com<br>";
		$txt .= "Versão: 2.0  -  Licença: GPL/GNU";
		return $txt;
	}
	...
	public function getCreditos() {
		$str  = "/*\n";
		$str .= " *\tSistema: Gerador de Classes PHP5\n";
		$str .= " *\tAutor: Diego Gomes Araujo\n";
		$str .= " *\tEmail: diegogomesaraujo@hotmail.com\n";
		$str .= " *\tVersão: 1.0\n";
		$str .= " *\tLicença: GPL/GNU\n";
		$str .= " *\tData da criação: 22/03/2008\n";
		$str .= " *\tHora da criação: 13:45:05\n";
		$str .= " *\n";
